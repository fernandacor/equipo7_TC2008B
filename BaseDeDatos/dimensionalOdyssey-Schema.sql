...
CREATE TABLE personajes(
    ...
    xp FLOAT NOT NULL,
    idArma SMALLINT UNSIGNED NULL,
    idPartida SMALLINT UNSIGNED NOT NULL,
    velocidadMov FLOAT NOT NULL,
    velocidadDis FLOAT NOT NULL,
    vida FLOAT NOT NULL,
    resistencia FLOAT NOT NULL,
    recuperacionEn FLOAT NOT NULL,
	enemiesKilled FLOAT NOT NULL,
    damageDealt FLOAT NOT NULL,
    coinsTaken FLOAT NOT NULL,
